...
import (
	...
	npm "github.com/Azure/azure-container-networking/npm"
...
func (m *MockGenericDataplane) AddToList(listName string, setNames []string) error {
	m.ctrl.T.Helper()
...
func (m *MockGenericDataplane) AddToSet(setNames []string, ip, podKey string) error {
	m.ctrl.T.Helper()
...
func (m *MockGenericDataplane) CreateIPSet(setName string, setType ipsets.SetType) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateIPSet", setName, setType)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateIPSet indicates an expected call of CreateIPSet.
func (mr *MockGenericDataplaneMockRecorder) CreateIPSet(setName, setType interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateIPSet", reflect.TypeOf((*MockGenericDataplane)(nil).CreateIPSet), setName, setType)
}

// DeleteIPSet mocks base method.
func (m *MockGenericDataplane) DeleteIPSet(name string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteIPSet", name)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteIPSet indicates an expected call of DeleteIPSet.
func (mr *MockGenericDataplaneMockRecorder) DeleteIPSet(name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteIPSet", reflect.TypeOf((*MockGenericDataplane)(nil).DeleteIPSet), name)
}
...
func (m *MockGenericDataplane) RemoveFromList(listName string, setNames []string) error {
	m.ctrl.T.Helper()
...
func (m *MockGenericDataplane) RemoveFromSet(setNames []string, ip, podKey string) error {
	m.ctrl.T.Helper()
...
func (m *MockGenericDataplane) UpdatePod(pod *npm.NpmPod) error {
	m.ctrl.T.Helper()

...
type nmagentClient interface {
	...
	RegisterNodeStandAlone(context.Context, nma.RegisterNodeStandAloneRequest) error
}
...
func (service *HTTPRestService) Init(config *common.ServiceConfig) error {
	...
	listener.AddHandler(cns.RegisterNodeStandAlone, service.registerNodeStandAlone)
	...
	listener.AddHandler(cns.V2Prefix+cns.RegisterNodeStandAlone, service.registerNodeStandAlone)
